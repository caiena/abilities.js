(function (global, factory) {
	...
	(global = global || self, factory(global.abilities = {}));
	...
	function getSubjectName(subject) {
	  ...
	  var Type = _typeof_1(subject) === 'object' ? subject.constructor : subject;
	...
	Rule = /*#__PURE__*/function () {
	  function Rule(params) {var _this = this;classCallCheck(this, Rule);
	    ...
	    if (this.condition == null) {// null or undefined
	      ...
	      throw Error("Unsupported type for condition: ".concat(_typeof_1(this.condition)));
	    }
	  }createClass(Rule, [{ key: "matches", value: function matches(
	...
	Ability = /*#__PURE__*/function () {createClass(Ability, null, [{ key: "addAlias", value: function addAlias(
	    alias, actions) {
	  ...
	  function Ability(rules) {var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},_ref$RuleType = _ref.RuleType,RuleType = _ref$RuleType === void 0 ? Rule : _ref$RuleType,_ref$subjectName = _ref.subjectName,subjectName = _ref$subjectName === void 0 ? getSubjectName : _ref$subjectName;classCallCheck(this, Ability);
	    this.__private = {
	      RuleType: RuleType,
	    ...
	    this.update(rules);
	  }createClass(Ability, [{ key: "update", value: function update(
	...
	AsyncAbility = /*#__PURE__*/function (_Ability) {inherits(AsyncAbility, _Ability);function AsyncAbility() {classCallCheck(this, AsyncAbility);return possibleConstructorReturn(this, getPrototypeOf(AsyncAbility).apply(this, arguments));}createClass(AsyncAbility, [{ key: "relevantRuleFor",

	    // override
	    // - async
	    value: function () {var _relevantRuleFor = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(action, subject, field) {var rules, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, rule;return regenerator.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
	    ...
	    // override
	    // - async
	  }, { key: "can", value: function () {var _can = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(action, subject, field) {var rule;return regenerator.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!(
	    ...
	    // override
	    // - async
	  }, { key: "cannot", value: function () {var _cannot = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {var can,_args3 = arguments;return regenerator.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
	    ...
	    // override
	    // - async
	  }, { key: "throwUnlessCan", value: function () {var _throwUnlessCan = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {var _len,args,_key,rule,action,subject,field,subjectName,_args4 = arguments;return regenerator.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:for (_len = _args4.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = _args4[_key];}_context4.next = 3;return (
	...
	RuleBuilder = /*#__PURE__*/function () {
	  function RuleBuilder(rule) {classCallCheck(this, RuleBuilder);
	    this.rule = rule;
	  }createClass(RuleBuilder, [{ key: "because", value: function because(
	...
	AbilityBuilder = /*#__PURE__*/function () {createClass(AbilityBuilder, null, [{ key: "define", value: function define(
	  ...
	  function AbilityBuilder() {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$subjectName = _ref.subjectName,subjectName = _ref$subjectName === void 0 ? getSubjectName : _ref$subjectName;classCallCheck(this, AbilityBuilder);
	    this.rules = [];
	    this.__private = {
	      subjectName: subjectName };

	  }createClass(AbilityBuilder, [{ key: "can", value: function can(
	...
	AsyncAbilityBuilder = /*#__PURE__*/function (_AbilityBuilder) {inherits(AsyncAbilityBuilder, _AbilityBuilder);function AsyncAbilityBuilder() {classCallCheck(this, AsyncAbilityBuilder);return possibleConstructorReturn(this, getPrototypeOf(AsyncAbilityBuilder).apply(this, arguments));}createClass(AsyncAbilityBuilder, null, [{ key: "define", value: function define(
	    dsl) {var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	      var builder = new this();
	      var result = dsl(builder.can.bind(builder), builder.cannot.bind(builder));
